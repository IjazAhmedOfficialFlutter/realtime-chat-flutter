...
class _ChatPageState extends State<ChatPage> {
  ...
  final int _receiverId = 2;
  final String _receiverName = 'Test User';
  ...
  Future<void> _sendMessage() async {
    ...
    if (message.isEmpty || _status != 'Connected') {
      return;
    }
          ...
          children: [
            ...
            Material(
              ...
              child: InkWell(
                ...
                onTap: _status == 'Connected' ? _sendMessage : null,
                child: const Padding(
